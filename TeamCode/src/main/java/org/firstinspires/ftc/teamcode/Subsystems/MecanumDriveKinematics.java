...
public class MecanumDriveKinematics {
    ...
    private void setInverseKinematics(Translation2d fl, Translation2d fr,
        ...
        m_inverseKinematics.setRow(0, 0, 1, -Math.sqrt(2), -(fl.getX() + fl.getY()));
        m_inverseKinematics.setRow(1, 0, 1, Math.sqrt(2), fr.getX() - fr.getY());
        m_inverseKinematics.setRow(2, 0, 1, Math.sqrt(2), rl.getX() - rl.getY());
        m_inverseKinematics.setRow(3, 0, 1, -Math.sqrt(2), -(rr.getX() + rr.getY()));
//        m_inverseKinematics = m_inverseKinematics.scale(1.0 / Math.sqrt(2)); //Error (shouldn't be applied to vx and omega)
    }
}
