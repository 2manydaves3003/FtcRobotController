...
import org.firstinspires.ftc.teamcode.Commands.BasicOdometryCommand;
...
public class SWTestBot extends Robot {
    ...
    private void setupOpMode(OpModeType type)
    {
        ...
        else if (type == OpModeType.VELOCITY_CONTROL_TUNE)
        {
    ...
    private void setupTeleOp()
    {
        ...
        m_robotLocalization.setDefaultCommand(new BasicOdometryCommand(m_robotLocalization));
